...
export function Indigenous() {
    ...
    return (
        <div className="chart-container">
            ...
            <div 
                className={`indigenous-sidebar ${isResizing ? 'resizing' : ''}`}
                ref={sidebarRef}
            ...
            >
                ...
                <p>
                    ...
                    <strong>Women</strong>
                    <br></br>&nbsp;&nbsp;&nbsp;&nbsp;
                    The inclusion of women and some of the challenges women face have already been examined in other sections of this primer/ This section will explore those concepts in greater detail and highlight other concepts not yet mentioned.
                    <br></br>&nbsp;&nbsp;&nbsp;&nbsp;
